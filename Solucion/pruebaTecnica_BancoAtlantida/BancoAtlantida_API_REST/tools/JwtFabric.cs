...
{
    //Clase con funciones relacionadas a la creacion,verificacion de autenticacion y decodificacion de token JWT para las 
    //peticiones de usuario a la api
    public class JwtFabric
    {
