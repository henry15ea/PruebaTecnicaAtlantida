...
using PortalAtlantida.Pages.portalUsuario;
using PortalAtlantida.tools;
using System;
using System.Threading.Tasks;

namespace PortalAtlantida.Pages.Shared
{
    public class _layoutUsuarioModel : PageModel
    {
        private readonly ILogger<_layoutUsuarioModel> _logger;
        ...
        public _layoutUsuarioModel(ILogger<_layoutUsuarioModel> logger, IHttpContextAccessor httpContextAccessor)
        {
            _logger = logger;
